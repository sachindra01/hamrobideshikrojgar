...
class MedicalcenterDetailScreen extends StatefulWidget {
  ...
  MedicalcenterDetailScreen(
      {Key key, @required this.id, @required this.iconUrl})
      : super(key: key);

  @override
  _MedicalcenterDetailsScreenState createState() =>
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "${Medicalcenterlist[widget.id].title}",
                        style: Theme.of(context).textTheme.headline,
                      ),
                      Row(
                        children: <Widget>[
                          Text(
                            "${Medicalcenterlist[widget.id].location}",
                      ...
                      Text(
                        "${Medicalcenterlist[widget.id].description}",
                        style: Theme.of(context)
                            .textTheme
                            .body2
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            "${Medicalcenterlist[widget.id].number}",
                            style: Theme.of(context)
                                .textTheme
                                .body2
                                .apply(color: Colors.black),
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: Medicalcenterlist[widget.id].photos.length,
                          itemBuilder: (ctx, i) {
                            return Padding(
                              padding:
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                    "${Medicalcenterlist[widget.id].photos[i]}"),
                              ),
                            );
                          },
                        ),
