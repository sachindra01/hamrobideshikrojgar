...
class EmbassyDetailsScreen extends StatefulWidget {
  final int id;
  String iconUrl;

  EmbassyDetailsScreen({Key key, @required this.id, @required this.iconUrl})
      : super(key: key);

  @override
  _EmbassyDetailsScreenState createState() => _EmbassyDetailsScreenState();
}

class _EmbassyDetailsScreenState extends State<EmbassyDetailsScreen> {
  @override
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "${Embassylist[widget.id].title}",
                        style: Theme.of(context).textTheme.headline,
                      ),
                      Row(
                        children: <Widget>[
                          Text(
                            "${Embassylist[widget.id].location}",
                      ...
                      Text(
                        "${Embassylist[widget.id].description}",
                        style: Theme.of(context)
                            .textTheme
                            .body2
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: Embassylist[widget.id].photos.length,
                          itemBuilder: (ctx, i) {
                            return Padding(
                              padding:
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                    "${Embassylist[widget.id].photos[i]}"),
                              ),
                            );
                          },
                        ),
