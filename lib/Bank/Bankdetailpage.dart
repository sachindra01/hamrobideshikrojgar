...
class BankDetailScreen extends StatefulWidget {
  ...
  BankDetailScreen({Key key, @required this.id, @required this.iconUrl})
      : super(key: key);
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "${Banklist[widget.id].title}",
                        style: Theme.of(context).textTheme.headline,
                      ),
                      Row(
                        children: <Widget>[
                          Text(
                            "${Banklist[widget.id].location}",
                      ...
                      Text(
                        "${Banklist[widget.id].description}",
                        style: Theme.of(context)
                            .textTheme
                            .body2
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: Banklist[widget.id].photos.length,
                          itemBuilder: (ctx, i) {
                            return Padding(
                              padding:
