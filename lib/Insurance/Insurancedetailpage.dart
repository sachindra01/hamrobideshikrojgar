...
class InsuranceDetailScreen extends StatefulWidget {
  ...
  InsuranceDetailScreen({Key key, @required this.id, @required this.iconUrl})
      : super(key: key);
...
class _InsuranceDetailsScreenState extends State<InsuranceDetailScreen> {
  @override
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Text(
                            "${Insurancelist[widget.id].location}",
                            style: Theme.of(context).textTheme.body2.apply(
                                color: Colors.grey, fontSizeFactor: 0.80),
                          ),
                        ],
                      ),
                      SizedBox(
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            "${Insurancelist[widget.id].description}",
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            "${Insurancelist[widget.id].number}",
                            style: Theme.of(context)
                                .textTheme
                                .body2
                                .apply(color: Colors.black),
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: Insurancelist[widget.id].photos.length,
                          itemBuilder: (ctx, i) {
                            return Padding(
                              padding:
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                    "${Insurancelist[widget.id].photos[i]}"),
                              ),
                            );
                          },
                        ),
